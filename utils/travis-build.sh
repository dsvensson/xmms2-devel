...
function linux_build_analysis {
    ...
    git clone https://github.com/rdoc/rdoc.git
    (gem install hoe kpeg racc json && cd rdoc && git reset --hard v4.2.2-12-g3f1ae6a && rake package && cd pkg && gem install --local *.gem)
