...
xmms_stream_type_t *xmms_stream_type_coerce (const xmms_stream_type_t *in, GPtrArray *stream_type_goals);
xmms_stream_type_t *xmms_stream_type_new (const gchar *begin, ...);
