...
xmmsv_coll_t *xmmsv_coll_new (xmmsv_coll_type_t type) XMMS_PUBLIC;
xmmsv_coll_t *xmmsv_coll_ref (xmmsv_coll_t *coll) XMMS_PUBLIC;
void xmmsv_coll_unref (xmmsv_coll_t *coll) XMMS_PUBLIC;
...
size_t xmmsv_coll_idlist_get_size (xmmsv_coll_t *coll) XMMS_PUBLIC;

xmmsv_coll_type_t xmmsv_coll_get_type (xmmsv_coll_t *coll) XMMS_PUBLIC;
const int32_t *xmmsv_coll_get_idlist (xmmsv_coll_t *coll) XMMS_DEPRECATED XMMS_PUBLIC;
struct xmmsv_St *xmmsv_coll_idlist_get (xmmsv_coll_t *coll) XMMS_PUBLIC;

void xmmsv_coll_attribute_set (xmmsv_coll_t *coll, const char *key, const char *value) XMMS_PUBLIC;
int xmmsv_coll_attribute_remove (xmmsv_coll_t *coll, const char *key) XMMS_PUBLIC;
int xmmsv_coll_attribute_get (xmmsv_coll_t *coll, const char *key, char **value) XMMS_PUBLIC;
void xmmsv_coll_attribute_foreach (xmmsv_coll_t *coll, xmmsv_coll_attribute_foreach_func func, void *user_data) XMMS_DEPRECATED XMMS_PUBLIC;

struct xmmsv_St *xmmsv_coll_attributes_get (xmmsv_coll_t *coll) XMMS_PUBLIC;

xmmsv_coll_t *xmmsv_coll_universe (void) XMMS_PUBLIC;

xmmsv_coll_t *xmmsv_coll_add_order_operator (xmmsv_coll_t *coll, const char *key) XMMS_PUBLIC;
